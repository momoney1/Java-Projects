...
import Assignment1.NoUpperAlphaException;
import Assignment1.NoDigitException;
import Assignment1.NoLowerAlphaException;
import Assignment1.LengthException;
import Assignment1.UnmatchedException;
...
public class PasswordCheckerTest {
	...
	public void testValidPasswords() {
		...
		System.out.print(nextResults);
		assertTrue(nextResults.contains("lowercase"));
		assertEquals(nextResults, " the password must contain at least one lowercase alphabetic character");
